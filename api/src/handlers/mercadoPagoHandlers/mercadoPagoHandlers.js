...
const {createPago, getPago} = require('../../controllers/mercadoPagoController/mercadoPagoController')
...
const POST_PAGO = async (req, res) => {
  try {
    ...
    console.log(id, title, description, picture_url, quantity, currency_id, unit_price)
